 ...
 *   each unique element appears only once. The relative order of the elements should be kept the same. Since it is
 *   impossible to change the length of the array in some languages, you must instead have the result be placed in
